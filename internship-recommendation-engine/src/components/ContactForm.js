            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300">Get help via email within 24 hours</p>
                  <p className="text-purple-200">support@pminternship.gov.in</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300">Chat with our support team instantly</p>
                  <p className="text-blue-200">Available 9 AM - 6 PM IST</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-white mb-2">Personal Guidance</h3>
                  <p className="text-gray-300">Get one-on-one career counseling</p>
                  <p className="text-green-200">Book a free session</p>
                </div>
              </div>
            </div>
          </div>
